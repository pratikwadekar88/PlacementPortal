...
function PostPage() {
  ...
  //fixed PostQuery.data bug
  if (!postQuery.data) return <h3>Loading...</h3>;
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          }" specially for PICT on Interview Experience. ${generateTextFromHTML(
        ...
        <meta
          property="og:url"
          content={`${import.meta.env.VITE_BASE_CLIENT_URL}/post/${id}`}
        />
